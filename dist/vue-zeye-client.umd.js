...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vue'), require('js-cookie'), require('pokemon'), require('protoo-client'), require('mediasoup-client'), require('hark')) :
  typeof define === 'function' && define.amd ? define(['vue', 'js-cookie', 'pokemon', 'protoo-client', 'mediasoup-client', 'hark'], factory) :
  (global = global || self, global.VueZeyeClient = factory(global.Vue, global.jsCookie, global.pokemon, global.protooClient, global.mediasoupClient, global.hark));
}(this, (function (Vue, jsCookie, pokemon, protooClient, mediasoupClient, hark) { 'use strict';
